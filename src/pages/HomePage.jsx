...
const HomePage = () => {
  return (
    <div className='w-full bg-white h-[100vh]'>
        <Navbar />
        <div className='px-[40px] relative bg-white flex flex-col items-center justify-center w-full h-full'>
          <div className='flex flex-col items-center justify-center w-[60%] text-center mb-4'>
            <h1 className='text-black font-bold text-5xl mb-3'>Mental Health Counselling At Your Convenience.</h1>
          ...
          <div className='absolute left-5 z-2 top-20 bg-gray-400 text-white p-2 rounded-sm'>
            <p>Hey, I am Uzima AI, your counsellor today...</p>
          </div>
          <div className='absolute right-5 z-2 bottom-50 bg-gray-400 text-white p-2 rounded-sm'>
